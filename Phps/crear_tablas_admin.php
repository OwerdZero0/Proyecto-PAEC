...
CREATE TABLE IF NOT EXISTS recoleccion (
    ...
    cantidad_pet DECIMAL(10,3) NOT NULL DEFAULT 0.000,
    material_carton TINYINT(1) NOT NULL DEFAULT 0,
    cantidad_carton DECIMAL(10,3) NOT NULL DEFAULT 0.000,
    material_tapas TINYINT(1) NOT NULL DEFAULT 0,
    cantidad_tapas DECIMAL(10,3) NOT NULL DEFAULT 0.000,
    material_vidrio TINYINT(1) NOT NULL DEFAULT 0,
    cantidad_vidrio DECIMAL(10,3) NOT NULL DEFAULT 0.000,
    material_electrodomesticos TINYINT(1) NOT NULL DEFAULT 0,
    cantidad_electrodomesticos DECIMAL(10,3) NOT NULL DEFAULT 0.000,
    material_papel TINYINT(1) NOT NULL DEFAULT 0,
    cantidad_papel DECIMAL(10,3) NOT NULL DEFAULT 0.000,
    material_pilas TINYINT(1) NOT NULL DEFAULT 0,
    cantidad_pilas DECIMAL(10,3) NOT NULL DEFAULT 0.000,
    material_aluminio TINYINT(1) NOT NULL DEFAULT 0,
    cantidad_aluminio DECIMAL(10,3) NOT NULL DEFAULT 0.000,
